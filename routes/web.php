...
Route::get('/codedbs/add', [ CodesController::class, 'addCodes']);
Route::get('/codedbs/list', [ CodesController::class, 'getListOfDbscodes']);
Route::get('/codedbs/delete', [ CodesController::class, 'getListOfDbscodes']);
